...
interface BookingCreateDialogProps {
  ...
  onCreated: (newBooking: Booking) => void;
}

const statusOptions = ["جديد", "مؤكد", "ملغي", "مكتمل", "قيد الانتظار"];
const categoryOptions = ["عزاب", "عوائل"];

export function BookingCreateDialog({ open, onOpenChange, onCreated }: BookingCreateDialogProps) {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      const payload = {
        ...
        ticket_issue_date: formData.ticket_issue_date || new Date().toISOString().split("T")[0],
      ...
      // Sync loyalty account for this customer
      if (formData.phone) {
        await syncLoyaltyForPhone(formData.phone);
      }
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 py-4">
          ...
          <div className="space-y-2">
            ...
            <Select
              ...
              onValueChange={(value) => handleInputChange("booking_category", value)}
            >
              <SelectTrigger>
